...
const Header: React.FC<HeaderProps> = ({ page, onNavigateHome }) => {
  return (
      ...
      <div className="flex-1">
        {page !== 'home' && (
            <button 
                ...
                className="flex items-center gap-2 text-gray-300 hover:text-white hover:bg-white/10 px-3 py-2 rounded-md transition-all duration-200"
