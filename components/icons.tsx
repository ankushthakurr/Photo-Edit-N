...
export const PhotoSuiteIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const LogoIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.007 1.11-1.11a12.001 12.001 0 0 1 5.052 0c.55.103 1.02.568 1.11 1.11a12.001 12.001 0 0 1 0 5.052c-.103.55-.568 1.02-1.11 1.11a12.001 12.001 0 0 1-5.052 0c-.55-.103-1.02-.568-1.11-1.11a12.001 12.001 0 0 1 0-5.052ZM-4.838 8.852 1.42 21.042m-.646-17.026L21.042 1.42m-17.026.646 17.026 17.026" />
    </svg>
);

export const MockupIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 17.25v1.007a3 3 0 0 1-.375 .565A3 3 0 0 1 8.25 19.5H4.5a3 3 0 0 1-3-3V5.25a3 3 0 0 1 3-3h3.75c.621 0 1.223.24 1.688.656l3.625 3.625c.416.416.656.967.656 1.688V13.5M9 17.25h1.875a3 3 0 0 0 3-3V9.75M9 17.25 12.75 14.5" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12.75 14.5.75 4.5m12 10 6-6.75" />
    </svg>
);